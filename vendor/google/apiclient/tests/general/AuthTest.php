...
PK;
  ...
  public function testVerifySignedJwtWithCerts()
  {
    ...
    $ticket = $oauth2->verifySignedJwtWithCerts($id_token, $certs, "clientId");
    ...
    $this->assertEquals("clientId", $attributes["payload"]["aud"]);
  }
  ...
  private function checkIdTokenFailure($id_token, $msg, $issuer = null)
  {
    ...
    $oauth2 = new Google_Auth_OAuth2($this->getClient());
    try {
      $oauth2->verifySignedJwtWithCerts($id_token, $certs, "clientId", $issuer);
