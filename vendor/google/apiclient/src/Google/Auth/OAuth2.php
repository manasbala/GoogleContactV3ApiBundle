...
class Google_Auth_OAuth2 extends Google_Auth_Abstract
{
  ...
  public function authenticate($code, $crossClient = false)
  {
    ...
    $arguments = array(
          ...
          'clientId' => $this->client->getClassConfig($this, 'clientId'),
          'clientSecret' => $this->client->getClassConfig($this, 'clientSecret')
    );
  ...
  public function sign(Google_Http_Request $request)
  {
    ...
    if ($this->client->getClassConfig($this, 'developerKey')) {
      $request->setQueryParam('key', $this->client->getClassConfig($this, 'developerKey'));
    }
  ...
  public function verifyIdToken($id_token = null, $audience = null)
  {
    ...
    if (!$audience) {
      $audience = $this->client->getClassConfig($this, 'clientId');
    }
